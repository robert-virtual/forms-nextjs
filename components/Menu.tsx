...
export const Menu = () => {
  const [left, setLeft] = useState<"-left-72" | "left-0">("-left-72");
  function toggleMenu() {
  ...
  return (
    <>
      ...
      <nav>
        ...
        >
          <div>
            ...
            <ul>
              <li>
                <Link href={"/documents"}>
                  <div className="btn-link text-blue-600">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-6 w-6"
                      fill="none"
              ...
              <li>
                <Link href={"/documents"}>
                  <div className="btn-link text-green-600">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-6 w-6"
                      fill="none"
                    ...
                    <span>Hojas de Calculo</span>
                  </div>
                </Link>
              </li>
              <li>
                <Link href={"/documents"}>
                  <div className="btn-link text-yellow-400">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-5 w-5"
                      viewBox="0 0 20 20"
          ...
          <ul className="px-4 py-8 flex text-[12px] justify-between text-gray-500">
            <li>
        ...
        {left == "left-0" && (
          <div
            onClick={() => setLeft("-left-72")}
            className="overlay  w-screen h-screen fixed top-0"
          ></div>
        )}
      </nav>
    </>
